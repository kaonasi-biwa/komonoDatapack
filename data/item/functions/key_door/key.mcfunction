execute in dimension:komono run item replace block 0 0 0 container.10 with stick{kaonasi:"item",display:{Name:'{"translate":"kaonasi.komono.key_door.key.name","italic": false}'},CustomModelData:60021,komono_id:"key"}
...
execute in dimension:komono run summon item ~ ~ ~ {Tags:["Key"],Item:{id:"minecraft:stick",Count:1b}}
