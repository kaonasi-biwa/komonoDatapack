...
execute if block ~ ~ ~ #industry:pomp_water run scoreboard players add @e[tag=pump,limit=1,sort=nearest] pump 1
...
execute if block ~ ~ ~ #industry:pomp_block run scoreboard players add @e[tag=pump,limit=1,sort=nearest] pump 1
