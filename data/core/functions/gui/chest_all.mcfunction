...
loot replace block ~ ~-1 ~ container.12 loot re_craft:glass
loot replace block ~ ~-1 ~ container.13 loot re_craft:glass
loot replace block ~ ~-1 ~ container.14 loot re_craft:glass
...
execute if entity @s[tag=!direction] run tag @s add direction